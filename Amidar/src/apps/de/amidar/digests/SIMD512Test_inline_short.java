...
import fr.cryptohash.SIMD512Digest_inline;

public class SIMD512Test_inline_short {
	...
	SIMD512Test_inline_short simd512test = new SIMD512Test_inline_short();
	...
	SIMD512Digest_inline digest = new SIMD512Digest_inline();
