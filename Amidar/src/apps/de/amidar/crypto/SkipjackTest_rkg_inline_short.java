...
import org.bouncycastle.crypto.engines.SkipjackEngine_inline;

import org.bouncycastle.crypto.params.KeyParameter;

public class SkipjackTest_rkg_inline_short {
	...
	SkipjackTest_rkg_inline_short skipjacktest = new SkipjackTest_rkg_inline_short(key);
	skipjacktest.run(data);

    }

    public SkipjackTest_rkg_inline_short(byte[] key) {
	this.key = key;
    }
	...
	SkipjackEngine_inline engine = new SkipjackEngine_inline();
