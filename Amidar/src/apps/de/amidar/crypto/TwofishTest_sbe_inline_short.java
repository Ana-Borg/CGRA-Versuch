...
public class TwofishTest_sbe_inline_short {
	...
	TwofishTest_sbe_inline_short twofishtest = new TwofishTest_sbe_inline_short(key);
	twofishtest.run(data);

    }

    public TwofishTest_sbe_inline_short(byte[] key) {
	this.key = key;
    }
	...
	TwofishEngine_onedim engine = new TwofishEngine_onedim();
