...
public class TwofishTest_rkg_inline_long {
	...
	TwofishTest_rkg_inline_long twofishtest = new TwofishTest_rkg_inline_long(key);
	twofishtest.run(data);

    }

    public TwofishTest_rkg_inline_long(byte[] key) {
	this.key = key;
    }
