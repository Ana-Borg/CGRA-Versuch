...
public class TwofishTest_sbe_inline_long {
	...
	TwofishTest_sbe_inline_long twofishtest = new TwofishTest_sbe_inline_long(key);
	twofishtest.run(data);

    }

    public TwofishTest_sbe_inline_long(byte[] key) {
	this.key = key;
    }
