...
public class SerpentTest_rkg_inline_long {
	...
	SerpentTest_rkg_inline_long serpenttest = new SerpentTest_rkg_inline_long(key);
	serpenttest.run(data);

    }

    public SerpentTest_rkg_inline_long(byte[] key) {
	this.key = key;
    }
