...
public class BlowfishTest_rkg_inline_long {
	...
	byte[] key = {
    	...
    	BlowfishTest_rkg_inline_long blowfishtest = new BlowfishTest_rkg_inline_long(key);
	blowfishtest.run(data);
    
    }
    
    public BlowfishTest_rkg_inline_long(byte[] key) {
    	this.key = key;
    }
