...
public class TwofishTest_rkg_inline_short {
	...
	TwofishTest_rkg_inline_short twofishtest = new TwofishTest_rkg_inline_short(key);
	twofishtest.run(data);

    }

    public TwofishTest_rkg_inline_short(byte[] key) {
	this.key = key;
    }
