...
public class DESedeTest_rkg_inline_short {
	...
	DESedeTest_rkg_inline_short destest = new DESedeTest_rkg_inline_short(key);
	destest.run(data);

    }

    public DESedeTest_rkg_inline_short(byte[] key) {
	this.key = key;
    }
