...
public class SkipjackTest_rkg_inline_long {
	...
	SkipjackTest_rkg_inline_long skipjacktest = new SkipjackTest_rkg_inline_long(key);
	skipjacktest.run(data);

    }

    public SkipjackTest_rkg_inline_long(byte[] key) {
	this.key = key;
    }
