...
public class RC6Test_rkg_inline_short {
	...
	RC6Test_rkg_inline_short rc6test = new RC6Test_rkg_inline_short(key);
	rc6test.run(data);

    }

    public RC6Test_rkg_inline_short(byte[] key) {
	this.key = key;
    }
	...
	RC6Engine_inline engine = new RC6Engine_inline();
