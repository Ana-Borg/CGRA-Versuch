...
public class SkipjackTest_sbe_inline_short {
	...
	SkipjackTest_sbe_inline_short skipjacktest = new SkipjackTest_sbe_inline_short(key);
	skipjacktest.run(data);

    }

    public SkipjackTest_sbe_inline_short(byte[] key) {
	this.key = key;
    }
