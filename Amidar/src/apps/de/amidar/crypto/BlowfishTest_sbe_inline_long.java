...
public class BlowfishTest_sbe_inline_long {
	...
	byte[] key = {
    	...
    	BlowfishTest_sbe_inline_long blowfishtest = new BlowfishTest_sbe_inline_long(key);
    	blowfishtest.run(data);
    
    }
    
    public BlowfishTest_sbe_inline_long(byte[] key) {
        this.key = key;
    }
