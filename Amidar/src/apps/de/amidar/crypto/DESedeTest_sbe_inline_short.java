...
public class DESedeTest_sbe_inline_short {
	...
	DESedeTest_sbe_inline_short destest = new DESedeTest_sbe_inline_short(key);
	destest.run(data);

    }

    public DESedeTest_sbe_inline_short(byte[] key) {
	this.key = key;
    }
