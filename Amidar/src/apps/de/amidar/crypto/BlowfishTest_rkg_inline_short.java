...
public class BlowfishTest_rkg_inline_short {
    ...
    public static void main(String[] args) {
        ...
        BlowfishTest_rkg_inline_short blowfishtest = new BlowfishTest_rkg_inline_short(key);
        blowfishtest.run(data);
    
    }
    
    public BlowfishTest_rkg_inline_short(byte[] key) {
        this.key = key;
    }
