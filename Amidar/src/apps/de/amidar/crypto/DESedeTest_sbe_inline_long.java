...
public class DESedeTest_sbe_inline_long {
	...
	DESedeTest_sbe_inline_long destest = new DESedeTest_sbe_inline_long(key);
	destest.run(data);

    }

    public DESedeTest_sbe_inline_long(byte[] key) {
	this.key = key;
    }
