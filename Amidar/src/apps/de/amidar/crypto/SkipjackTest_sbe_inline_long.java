...
public class SkipjackTest_sbe_inline_long {
	...
	SkipjackTest_sbe_inline_long skipjacktest = new SkipjackTest_sbe_inline_long(key);
	skipjacktest.run(data);

    }

    public SkipjackTest_sbe_inline_long(byte[] key) {
	this.key = key;
    }
