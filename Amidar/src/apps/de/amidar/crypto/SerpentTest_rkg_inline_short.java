...
public class SerpentTest_rkg_inline_short {
	...
	SerpentTest_rkg_inline_short serpenttest = new SerpentTest_rkg_inline_short(key);
	serpenttest.run(data);

    }

    public SerpentTest_rkg_inline_short(byte[] key) {
	this.key = key;
    }
