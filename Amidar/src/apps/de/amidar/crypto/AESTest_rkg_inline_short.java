...
public class AESTest_rkg_inline_short {
	...
	AESTest_rkg_inline_short aestest = new AESTest_rkg_inline_short(key);
	aestest.run(data);

    }

    public AESTest_rkg_inline_short(byte[] key) {
	this.key = key;
    }
	...
	AESEngine_inline engine = new AESEngine_inline();
