...
public class SerpentTest_sbe_inline_short {
	...
	SerpentTest_sbe_inline_short serpenttest = new SerpentTest_sbe_inline_short(key);
	serpenttest.run(data);

    }

    public SerpentTest_sbe_inline_short(byte[] key) {
	this.key = key;
    }
