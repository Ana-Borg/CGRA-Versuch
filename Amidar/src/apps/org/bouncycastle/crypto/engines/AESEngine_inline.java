...
//        int f8 = FFmulX(f4);
        ...
        return f2 ^ f4 ^ f8 ^ (((f2 ^ f9) >>> 8) | ((f2 ^ f9) << -8)) ^ (((f4 ^ f9) >>> 16) | ((f4 ^ f9) << -16)) ^ ((f9 >>> 24) | (f9 << -24));
    }
...
*/
	...
	int length = key.length;
        while (i < length)
            {
                W[(t >> 2) * 4 + (t & 3)] = (key[i]&0xff) | ((key[i+1]&0xff) << 8) | ((key[i+2]&0xff) << 16) | (key[i+3] << 24);
                i+=4;
                t++;
            }
        ...
        for (i = KC; (i < k); i++)
            {
                int temp = W[((i-1)>>2) * 4 + ((i-1)&3)];
                if ((i % KC) == 0)
                {
//                    temp = subWord(shift(temp, 8)) ^ rcon[(i / KC)-1];
//                    temp = subWord(((temp >>> 8) | (temp << -8))) ^ rcon[(i / KC)-1];
        		temp = (S[((temp >>> 8) | (temp << -8))&255]&255 | ((S[(((temp >>> 8) | (temp << -8))>>8)&255]&255)<<8) | ((S[(((temp >>> 8) | (temp << -8))>>16)&255]&255)<<16) | S[(((temp >>> 8) | (temp << -8))>>24)&255]<<24) ^ rcon[(i / KC)-1];
                }
                else if ((KC > 6) && ((i % KC) == 4))
                {
                    temp = (S[temp&255]&255 | ((S[(temp>>8)&255]&255)<<8) | ((S[(temp>>16)&255]&255)<<16) | S[(temp>>24)&255]<<24);
                }
        ...
        if (!forEncryption)
        {
            for (int j = 1; j < ROUNDS; j++)
            {
                for (i = 0; i < 4; i++)
                {
        		int f2 = (((W[j * 4 + i] & m2) << 1) ^ (((W[j * 4 + i] & m1) >>> 7) * m3));
		        int f4 = (((f2 & m2) << 1) ^ (((f2 & m1) >>> 7) * m3));
		        int f8 = (((f4 & m2) << 1) ^ (((f4 & m1) >>> 7) * m3));
		        int f9 = W[j * 4 + i] ^ f8;
        
		        W[j * 4 + i] = f2 ^ f4 ^ f8 ^ (((f2 ^ f9) >>> 8) | ((f2 ^ f9) << -8)) ^ (((f4 ^ f9) >>> 16) | ((f4 ^ f9) << -16)) ^ ((f9 >>> 24) | (f9 << -24));
               //     W[j * 4 + i] = inv_mcol(W[j * 4 + i]);
                }
            }
        }
	...
	int index = r * 4;
        ...
        while (r < ROUNDS - 1)
        {
            ...
            r0 = T0[C0&255] ^ ((T0[(C1>>8)&255] >>> 24) | (T0[(C1>>8)&255] << -24)) ^ ((T0[(C2>>16)&255] >>> 16) | (T0[(C2>>16)&255] << -16)) ^ ((T0[(C3>>24)&255] >>> 8) | (T0[(C3>>24)&255] << -8)) ^ KW[index];
            r1 = T0[C1&255] ^ ((T0[(C2>>8)&255] >>> 24) | (T0[(C2>>8)&255] << -24)) ^ ((T0[(C3>>16)&255] >>> 16) | (T0[(C3>>16)&255] << -16)) ^ ((T0[(C0>>24)&255] >>> 8) | (T0[(C0>>24)&255] << -8)) ^ KW[index + 1];
            r2 = T0[C2&255] ^ ((T0[(C3>>8)&255] >>> 24) | (T0[(C3>>8)&255] << -24)) ^ ((T0[(C0>>16)&255] >>> 16) | (T0[(C0>>16)&255] << -16)) ^ ((T0[(C1>>24)&255] >>> 8) | (T0[(C1>>24)&255] << -8)) ^ KW[index + 2];
            r3 = T0[C3&255] ^ ((T0[(C0>>8)&255] >>> 24) | (T0[(C0>>8)&255] << -24)) ^ ((T0[(C1>>16)&255] >>> 16) | (T0[(C1>>16)&255] << -16)) ^ ((T0[(C2>>24)&255] >>> 8) | (T0[(C2>>24)&255] << -8)) ^ KW[index + 3];
	    r++;
	    index += 4;

            C0 = T0[r0&255] ^ ((T0[(r1>>8)&255] >>> 24) | (T0[(r1>>8)&255] << -24)) ^ ((T0[(r2>>16)&255] >>> 16) | (T0[(r2>>16)&255] << -16)) ^ ((T0[(r3>>24)&255] >>> 8) | (T0[(r3>>24)&255] << -8)) ^ KW[index];
            C1 = T0[r1&255] ^ ((T0[(r2>>8)&255] >>> 24) | (T0[(r2>>8)&255] << -24)) ^ ((T0[(r3>>16)&255] >>> 16) | (T0[(r3>>16)&255] << -16)) ^ ((T0[(r0>>24)&255] >>> 8) | (T0[(r0>>24)&255] << -8)) ^ KW[index + 1];
            C2 = T0[r2&255] ^ ((T0[(r3>>8)&255] >>> 24) | (T0[(r3>>8)&255] << -24)) ^ ((T0[(r0>>16)&255] >>> 16) | (T0[(r0>>16)&255] << -16)) ^ ((T0[(r1>>24)&255] >>> 8) | (T0[(r1>>24)&255] << -8)) ^ KW[index + 2];
            C3 = T0[r3&255] ^ ((T0[(r0>>8)&255] >>> 24) | (T0[(r0>>8)&255] << -24)) ^ ((T0[(r1>>16)&255] >>> 16) | (T0[(r1>>16)&255] << -16)) ^ ((T0[(r2>>24)&255] >>> 8) | (T0[(r2>>24)&255] << -8)) ^ KW[index + 3];
	    r++;
	    index += 4;
	     
        }

        r0 = T0[C0&255] ^ shift(T0[(C1>>8)&255], 24) ^ shift(T0[(C2>>16)&255], 16) ^ shift(T0[(C3>>24)&255], 8) ^ KW[index];
        r1 = T0[C1&255] ^ shift(T0[(C2>>8)&255], 24) ^ shift(T0[(C3>>16)&255], 16) ^ shift(T0[(C0>>24)&255], 8) ^ KW[index + 1];
        r2 = T0[C2&255] ^ shift(T0[(C3>>8)&255], 24) ^ shift(T0[(C0>>16)&255], 16) ^ shift(T0[(C1>>24)&255], 8) ^ KW[index + 2];
        r3 = T0[C3&255] ^ shift(T0[(C0>>8)&255], 24) ^ shift(T0[(C1>>16)&255], 16) ^ shift(T0[(C2>>24)&255], 8) ^ KW[index + 3];
	index += 4;

        // the final round's table is a simple function of S so we don't use a whole other four tables for it

        C0 = (S[r0&255]&255) ^ ((S[(r1>>8)&255]&255)<<8) ^ ((S[(r2>>16)&255]&255)<<16) ^ (S[(r3>>24)&255]<<24) ^ KW[index];
        C1 = (S[r1&255]&255) ^ ((S[(r2>>8)&255]&255)<<8) ^ ((S[(r3>>16)&255]&255)<<16) ^ (S[(r0>>24)&255]<<24) ^ KW[index + 1];
        C2 = (S[r2&255]&255) ^ ((S[(r3>>8)&255]&255)<<8) ^ ((S[(r0>>16)&255]&255)<<16) ^ (S[(r1>>24)&255]<<24) ^ KW[index + 2];
        C3 = (S[r3&255]&255) ^ ((S[(r0>>8)&255]&255)<<8) ^ ((S[(r1>>16)&255]&255)<<16) ^ (S[(r2>>24)&255]<<24) ^ KW[index + 3];
	...
	int index = r * 4;
        ...
        while (r>1)
        {
            ...
            r0 = Tinv0[C0&255] ^ shift(Tinv0[(C3>>8)&255], 24) ^ shift(Tinv0[(C2>>16)&255], 16) ^ shift(Tinv0[(C1>>24)&255], 8) ^ KW[index];
            r1 = Tinv0[C1&255] ^ shift(Tinv0[(C0>>8)&255], 24) ^ shift(Tinv0[(C3>>16)&255], 16) ^ shift(Tinv0[(C2>>24)&255], 8) ^ KW[index + 1];
            r2 = Tinv0[C2&255] ^ shift(Tinv0[(C1>>8)&255], 24) ^ shift(Tinv0[(C0>>16)&255], 16) ^ shift(Tinv0[(C3>>24)&255], 8) ^ KW[index + 2];
            r3 = Tinv0[C3&255] ^ shift(Tinv0[(C2>>8)&255], 24) ^ shift(Tinv0[(C1>>16)&255], 16) ^ shift(Tinv0[(C0>>24)&255], 8) ^ KW[index + 3];

	    index -= 4;
	    r--;

            C0 = Tinv0[r0&255] ^ shift(Tinv0[(r3>>8)&255], 24) ^ shift(Tinv0[(r2>>16)&255], 16) ^ shift(Tinv0[(r1>>24)&255], 8) ^ KW[index];
            C1 = Tinv0[r1&255] ^ shift(Tinv0[(r0>>8)&255], 24) ^ shift(Tinv0[(r3>>16)&255], 16) ^ shift(Tinv0[(r2>>24)&255], 8) ^ KW[index + 1];
            C2 = Tinv0[r2&255] ^ shift(Tinv0[(r1>>8)&255], 24) ^ shift(Tinv0[(r0>>16)&255], 16) ^ shift(Tinv0[(r3>>24)&255], 8) ^ KW[index + 2];
            C3 = Tinv0[r3&255] ^ shift(Tinv0[(r2>>8)&255], 24) ^ shift(Tinv0[(r1>>16)&255], 16) ^ shift(Tinv0[(r0>>24)&255], 8) ^ KW[index + 3];
