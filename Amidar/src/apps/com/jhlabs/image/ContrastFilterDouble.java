 ...
 */
public class ContrastFilterDouble {
	...
	public int[] filter(int[] inPixels) {
		...
		for (int index = 0; index < length; index++) {
			...
			int g = (rgb >> 8) & 0xff;
			int b = rgb & 0xff;
			r = (int) ((255 * (r / 255.0) * brightness - 0.5) * contrast + 0.5);
			if (r < 0)
				r = 0;
			if (r > 255)
				r = 255;
			g = (int) ((255 * (g / 255.0) * brightness - 0.5) * contrast + 0.5);
			if (g < 0)
				g = 0;
			if (g > 255)
				g = 255;
			b = (int) ((255 * (b / 255.0) * brightness - 0.5) * contrast + 0.5);
			if (b < 0)
				b = 0;
			if (b > 255)
				b = 255;
