...
public class RadioGatun32Digest_inline {
	 ...
	 * Build the object.
	 */
	public RadioGatun32Digest_inline()
	{
	...
	protected void processBlock(byte[] data)
	{
		...
		for (int mk = 12; mk >= 0; mk --) {
			...
			int p0 = ((data[3] & 0xFF) << 24) | ((data[2] & 0xFF) << 16) | ((data[1] & 0xFF) << 8) | (data[0] & 0xFF);
			// int p1 = decodeLEInt(data, dp + 4);
			int p1 = ((data[7] & 0xFF) << 24) | ((data[6] & 0xFF) << 16) | ((data[5] & 0xFF) << 8) | (data[4] & 0xFF);
			// int p2 = decodeLEInt(data, dp + 8);
			int p2 = ((data[11] & 0xFF) << 24) | ((data[10] & 0xFF) << 16) | ((data[9] & 0xFF) << 8) | (data[8] & 0xFF);
			dp += 12;
			...
			valueContainer[cntt++] = 9999;
			valueContainer[cntt++] = mk;
			...
			valueContainer[cntt++] = a15;
			valueContainer[cntt++] = a16;
			valueContainer[cntt++] = a17;
			valueContainer[cntt++] = 111111;
			...
			valueContainer[cntt++] = t15;
			valueContainer[cntt++] = a13;
			...
			valueContainer[cntt++] = t13;
			valueContainer[cntt++] = a13;
			valueContainer[cntt++] = b[mk*3];
			bj = mk * 3;
			a13 = a13 ^ b[bj + 0];
			a14 = a14 ^ b[bj + 1];
			a15 ^= b[bj + 2];
